...
response.setHeader("Expires", "0");
	...
	Software s = (Software) request.getAttribute("s");
%>
    <div id="wrapper">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <form role="form" action="salvarSoftware" method="POST">
                                    <input type="hidden" name="id" value="${s.id}"/>
                                        ...
                                        <div class="form-group">
                                            <label>Versão</label>
                                            <input type="text" name="versao" value="${s.versao}" class="form-control">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Serial</label>
                                            <input type="text" name="serial" value="${s.serial}" class="form-control">
                                        </div>                                              
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="colaborador">
                                            	...
                                            	<c:forEach var="c" items="${colaboradores}">
                                            		...
                                            		<c:if test="${s.colaborador.equals(c)}">
