...
response.setHeader("Expires", "0");
	...
	Monitor m = (Monitor) request.getAttribute("m");
%>
    <div id="wrapper">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <form role="form" action="salvarMonitor" method="POST">
                                    <input type="hidden" name="id" value="${m.id}"/>
                                    
                                        <div class="form-group">
                                            <label>Marca</label>
                                            <input type="text" name="marca" value="${m.marca}" class="form-control">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Modelo</label>
                                            <input type="text" name="modelo" value="${m.modelo}" class="form-control">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Data da Compra</label>
                                            <input type="text" name="dataCompra" value="${m.dataCompra}" class="form-control">
                                        </div>                                              
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="colaborador">
	                                            ...
	                                            <c:forEach var="c" items="${colaboradores}">
	                                            	...
	                                            	<c:if test="${m.colaborador.equals(c)}" >
