...
%>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Lista de Softwares</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                	<c:forEach var="s" items="${softwares}">
                                        ...
                                        <td>${s.versao}</td>
                                        <td>${s.serial}</td>
                                        <td class="center">${s.colaborador.nome}</td>
                                        <td>
                                        	<a href="javascript:alterarSoftware('${s.id}')">Alterar</a>
                                        	<a href="javascript:removerSoftware('${s.id}', '${s.nome}', '${s.versao}')">Remover</a>
                                        </td>
                                    </tr>
                                	</c:forEach>
                                </tbody>
