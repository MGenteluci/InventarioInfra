                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                	<c:forEach var="e" items="${equipamentos}">
                                        ...
                                        <td>${e.modelo}</td>
                                        <td>${e.serialTag}</td>
                                        <td>${e.dataGarantia}</td>
                                        <td class="center">${e.colaborador.nome}</td>
                                        <td>
                                        	<a href="javascript:alterarEquipamento('${e.id}')">Alterar</a>
                                        	<a href="javascript:removerEquipamento('${e.id}')">Remover</a>
                                        </td>
                                    </tr>
                                	</c:forEach>
                                </tbody>
